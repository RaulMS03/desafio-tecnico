...
from services.equipments_service import create_equipments, get_filtered_equipments, get_equipment_by_id, \
    change_equipment_status, update_equipment_by_id
from utils.responses import response
from utils.validators import validate_fields

equipments_bp = Blueprint("equipments_bp", __name__)

@equipments_bp.route("/equipamentos", methods=['GET', 'POST'])
@jwt_required()
def equipments_endpoint():
    ...
    if request.method == "POST":
        try:
            ...
            create_equipments(validate_data)
